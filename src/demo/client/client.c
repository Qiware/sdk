...
void client_set_conf(sdk_conf_t *conf)
{
    ...
    snprintf(conf->clientid, sizeof(conf->clientid), "ddb12a2d84fcd13fa38c34569");
    ...
    snprintf(conf->httpsvr, sizeof(conf->httpsvr), "10.154.157.39/client/conInfo");      /* HTTP端(IP+端口/域名) */
